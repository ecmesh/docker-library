...
docker tag registry.cn-beijing.aliyuncs.com/ecmesh/citadel:release-1.0-latest-daily docker.elastic.co/elasticsearch/elasticsearch-oss:6.4.0
...
docker tag registry.cn-beijing.aliyuncs.com/ecmesh/citadel:release-1.0-latest-daily docker.elastic.co/kibana/kibana-oss:6.4.0
...
docker tag registry.cn-beijing.aliyuncs.com/ecmesh/citadel:release-1.0-latest-daily docker.elastic.co/logstash/logstash-oss:6.2.2
